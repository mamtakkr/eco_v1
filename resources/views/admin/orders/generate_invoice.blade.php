    ...
    <div class="body-section">
      <div class="">
        <div class="">
          ...
          <p class="sub-heading">Email Address: {{$order->relUser->email}} </p>
        </div>
        <div class="">
          <p class="sub-heading">Full Name: {{$order->relShippingAddress->name}}</p>
          <p class="sub-heading">Address: {{$order->relShippingAddress->address}}</p>
          <p class="sub-heading">Phone Number: {{$order->relShippingAddress->contact}}</p>
          <p class="sub-heading">City,State,Pincode: {{$order->relShippingAddress->city}}, {{$order->relShippingAddress->state}}, {{$order->relShippingAddress->pincode}}</p>
        </div>
      </div>
    </div>
