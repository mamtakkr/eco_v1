...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="{{URL::to('/')}}/templates/admin/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
    </div>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="{{URL::to('/')}}/templates/admin/index3.html" class="nav-link">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="{{URL::to('/')}}/templates/admin/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
            ...
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="{{URL::to('/')}}/templates/admin/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                <div class="media-body">
                  <h3 class="dropdown-item-title">
                    John Pierce
            ...
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="{{URL::to('/')}}/templates/admin/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                <div class="media-body">
                  <h3 class="dropdown-item-title">
                    Nora Silvester
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('users-show')}}" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Customers</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{route('vendors-show')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Vendors</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              <a href="{{route('coupons-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Coupons
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('banners-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Banners
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('sliders-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Sliders
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('deal-of-days-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Deal Of Days
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('featured-products-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Featured Products
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('popular-products-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Popular Products
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('general-settings-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  General Settings
                </p>
