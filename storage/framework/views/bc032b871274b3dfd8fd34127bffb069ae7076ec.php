                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form method="post" action="<?php echo e(route('slider-create-action')); ?>" enctype="multipart/form-data" class="form-horizontal">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputPrice" class="col-sm-2 col-form-label">Short Description</label>
                                        <div class="col-sm-10">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eco_V1\resources\views/admin/sliders/slider_create.blade.php ENDPATH**/ ?>