                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form method="post" action="<?php echo e(route('product-create-action')); ?>" enctype="multipart/form-data" class="form-horizontal">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="discount" class="form-control" placeholder="Discount in %">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="conditions" class="form-control">
                                                ...
                                                <option value="new" <?php echo e(old('conditions')=='new' ? 'selected' : ''); ?>>New</option>
                                                <option value="popular" <?php echo e(old('conditions')=='popular' ? 'selected' : ''); ?>>Popular</option>
                                                <option value="winter" <?php echo e(old('conditions')=='winter' ? 'selected' : ''); ?>>Winter</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="size" class="form-control">
                                                ...
                                                <option value="XL" <?php echo e(old('size')=='XL' ? 'selected' : ''); ?>>Extra Large</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="short_description" id="short_description" class="form-control" placeholder="Short Description"><?php echo e(old('short_description')); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eco_V1\resources\views/admin/products/product_create.blade.php ENDPATH**/ ?>