...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="<?php echo e(URL::to('/')); ?>/templates/admin/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
    </div>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?php echo e(URL::to('/')); ?>/templates/admin/index3.html" class="nav-link">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="<?php echo e(URL::to('/')); ?>/templates/admin/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
            ...
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="<?php echo e(URL::to('/')); ?>/templates/admin/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                <div class="media-body">
                  <h3 class="dropdown-item-title">
                    John Pierce
            ...
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="<?php echo e(URL::to('/')); ?>/templates/admin/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                <div class="media-body">
                  <h3 class="dropdown-item-title">
                    Nora Silvester
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo e(route('users-show')); ?>" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Customers</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo e(route('vendors-show')); ?>" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Vendors</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('coupons-show')); ?>" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Coupons
                </p>
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('blogs-show')); ?>" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Blogs
                </p>
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('brands-show')); ?>" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Brands
                </p>
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('deal-of-days-show')); ?>" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Deal Of Days
                </p>
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('featured-products-show')); ?>" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Featured Products
                </p>
...
</html><?php /**PATH C:\xampp\htdocs\lara-projects\eco_V1\resources\views/layouts/admin.blade.php ENDPATH**/ ?>