          ...
          <div class="cnt-account">
            <ul class="list-unstyled">
              ...
              <?php else: ?>
                ...
                <?php else: ?>
                <li class="myaccount"><a href="<?php echo e(route('admin-index')); ?>"><span>Admin Dashboard</span></a></li>
                <?php endif; ?>
            ...
            <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
              <div class="nav-outer">
                <ul class="nav navbar-nav">
                  <li class="active dropdown"> <a href="<?php echo e(route('index')); ?>"><h6>Home</h6></a> </li>
                  <li class="active dropdown"> <a href="<?php echo e(route('shop')); ?>"><h6>Shop</h6></a> </li>
                  ...
                  <?php else: ?>
                  <li class="dropdown"> <a href="<?php echo e(route('product-cat',$cat->slug)); ?>"><h6><?php echo e(ucfirst($cat->title)); ?></h6></a> </li>
                  <?php endif; ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
                <!-- /.navbar-nav -->
...
</html><?php /**PATH C:\xampp\htdocs\lara-projects\eco_V1\resources\views/layouts/front.blade.php ENDPATH**/ ?>