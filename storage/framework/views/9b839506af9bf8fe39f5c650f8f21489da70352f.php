...
<div class="body-content">
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
				<tr>
					<td class="col-md-2 col-sm-6 col-xs-6"><img src="<?php echo e(URL::to('/')); ?>/templates/front/assets/images/products/p1.jpg" alt="imga"></td>
				...
				<tr>
					<td class="col-md-2"><img src="<?php echo e(URL::to('/')); ?>/templates/front/assets/images/products/p2.jpg" alt="phoro"></td>
					<td class="col-md-7">
						<div class="product-name"><a href="#">Floral Print Buttoned</a></div>
						<div class="rating">
							<i class="fa fa-star rate"></i>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eco_V1\resources\views/wishlist.blade.php ENDPATH**/ ?>