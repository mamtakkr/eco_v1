    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div align="right">
                        <a href="<?php echo e(route('popular-product-create')); ?>" class="btn btn-primary">Add New Popular Product</a><br>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info btn-sm" href="<?php echo e(route('popular-product-edit',$row['id'])); ?>"><i class="fas fa-pencil-alt"></i></a>
                                            <form name="myForm" method="POST" action="<?php echo e(route('popular-product-delete',$row['id'])); ?>" class="float-right">
                                                <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        $('input[name=toogle]').change(function() {
            ...
            // alert(id);
            $.ajax({
                url: "<?php echo e(route('ajax-popular-product-status-update')); ?>",
                method: "POST",
                data: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lara-projects\eco_V1\resources\views/admin/popular_products/popular_products_show.blade.php ENDPATH**/ ?>